# Questao 5
# 5. Seja o mesmo texto acima “splitado”. Calcule quantas palavras possuem uma das letras “python” e que tenham mais de 4 caracteres. 
...
texto = texto.translate(None, ',.') # removendo pontuacao do texto
